...
The goal of r-exploration is to share data visualisation experiments in R.
...
![Lollipop chart of top read articles in Canada](graph/wikipedia_pageviews_top_in_canada.png)
